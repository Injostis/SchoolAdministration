            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="text-center">
                        ...
                        <p>Apartado para editar una calificaciones del sistema.</p>
                    </div>

                    <% Calificacion calificacion = (Calificacion) request.getSession().getAttribute("calificacionEditar"); %>

                    <form accept-charset="UTF-8" class="user" action="SvEditCalificaciones" method="POST">
                        <div class="form-group row justify-content-center">
                            <div class="col-sm-6 mb-2">
                                <input type="number" class="form-control form-control-user" name="valor" id="valorInput" value="<%=calificacion.getValor()%>" placeholder="Valor" min="0" max="100" required>
                            </div>
                        </div>
                        <div class="form-group row justify-content-center">
                            <div class="col-sm-6">
